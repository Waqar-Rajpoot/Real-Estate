...
import { LogOut } from "lucide-react"; // Added this
import { cn } from "@/lib/utils";
import { ADMIN_NAV_GROUPS } from "@/constants/admin-nav";
    ...
    <div className="w-64 border-r border-slate-200 bg-slate-900 min-h-screen hidden md:flex flex-col sticky top-0 z-40">
      ...
      <div className="p-6 border-t border-slate-800 space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold text-rose-400 hover:bg-rose-500/10 hover:text-rose-300 transition-all duration-200 group"
        >
          <LogOut className="h-5 w-5 text-rose-500 group-hover:text-rose-400" />
          Logout Session
        </button>
