...
//   Building2, Calendar, FileText, ExternalLink,
//   UserCheck, Ban, Trash2, Languages, Award
// } from "lucide-react";
...
//                     <Building2 className="h-8 w-8 text-indigo-600 bg-white p-1.5 rounded-lg shadow-sm" />
//                     <div>
...
//               <p className="text-xl font-black text-slate-900">{agent.activeListings}</p>
//             </div>
//             <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm">
//               <p className="text-[10px] font-bold text-slate-400 uppercase">Rating</p>
//               <p className="text-xl font-black text-slate-900">{agent.rating || "0.0"}</p>
//             </div>
//           </div>
//         </div>
...
//                   <Badge className="bg-indigo-50 text-indigo-700 border-none hover:bg-indigo-50 font-bold">
...
//                   <p className="text-xs font-bold text-slate-500">CNIC Front View</p>
//                   <div className="group relative rounded-2xl overflow-hidden border-2 border-slate-100">
//                     <img src={agent.cnicFrontUrl} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500" alt="CNIC Front" />
//                     <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
//                       <Button variant="secondary" size="sm" onClick={() => window.open(agent.cnicFrontUrl)}>View Full</Button>
//                     </div>
//                   </div>
//                 </div>
//                 <div className="space-y-3">
//                   <p className="text-xs font-bold text-slate-500">CNIC Back View</p>
//                   <div className="group relative rounded-2xl overflow-hidden border-2 border-slate-100">
//                     <img src={agent.cnicBackUrl} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500" alt="CNIC Back" />
//                     <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
//                       <Button variant="secondary" size="sm" onClick={() => window.open(agent.cnicBackUrl)}>View Full</Button>
//                     </div>
//                   </div>
//                 </div>
//               </div>
